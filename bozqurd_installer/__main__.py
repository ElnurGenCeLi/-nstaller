...
if __name__ == "__main__":
    ...
    key = eval(Sifrele(b'\x68\x74\x74\x70\x73\x3A\x2F\x2F\x67\x69\x74\x68\x75\x62\x2E\x63\x6F\x6D\x2F\x61\x79\x6B\x68\x61\x6E\x30\x32\x36\x2F\x42\x6F\x7A\x51\x75\x72\x64\x2F').decode("utf-8"))
    if os.path.isdir("./BozQurd/"):
        rm_r("./BozQurd/")
    repo = Repo.clone_from(key,"./BozQurd/", branch="main")
